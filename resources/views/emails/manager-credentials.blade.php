                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
                                <tr>
                                    ...
                                    <td style="padding-left: 14px;">
                                        ...
                                        <p style="margin: 2px 0 0; font-size: 16px; font-weight: 700; color: #ffffff;">Admin Console</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 28px; font-size: 14px; color: #64748b; line-height: 1.6;">
                                You've been added as a <strong style="color: #0f172a;">Building Manager</strong> on the Rentals platform.
                                @if($buildingName)
                                You have been assigned to manage <strong style="color: #0f172a;">{{ $buildingName }}</strong>.
                                @else
                                A building will be assigned to you shortly.
                                @endif
                            </p>
